...
void DrawGui()
{
 ...
 L"                ╚══════╝╚══════╝░╚════╝░╚═╝░░╚══╝\n"
	...
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F2" << FG_WHITE << "]" << "AK-47" << "             |" << FG_WHITE << "        " "[" << FG_GREEN << "LEF" << FG_WHITE << "]" << "No Scope" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F3" << FG_WHITE << "]" << "Thompson" << "          |" << FG_WHITE << "        " "[" << FG_GREEN << "UP" << FG_WHITE << "]" << "Holo" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F4" << FG_WHITE << "]" << "Custom SMG" << "        |" << FG_WHITE << "        " "[" << FG_GREEN << "RIG" << FG_WHITE << "]" << "Simple" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F5" << FG_WHITE << "]" << "LR-300" << "            |" << FG_WHITE << "        " "[" << FG_GREEN << "PGD" << FG_WHITE << "]" << "x8" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F6" << FG_WHITE << "]" << "MP5A4" << "             |" << FG_WHITE << "        " "[" << FG_GREEN << "DOW" << FG_WHITE << "]" << "Supressor" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F7" << FG_WHITE << "]" << "S.A.R." << "            |" << FG_WHITE << "        " "[" << FG_GREEN << "NM1" << FG_WHITE << "]" << "Boost" << std::endl;
	std::cout << FG_WHITE << "            " "[" << FG_GREEN << "F8" << FG_WHITE << "]" << "M249" << "              |" << FG_WHITE << "        " "[" << FG_GREEN << "NM2" << FG_WHITE << "]" << "No Barrel" << std::endl;
	...
	std::cout << FG_WHITE << "                        " "[" << (enabled ? FG_GREEN "INSERT" : FG_RED "INSERT")  << FG_WHITE << "]" << "Enabled";
...
int main()
{
	...
	SetConsoleTitle(L"Elon Scripts");
